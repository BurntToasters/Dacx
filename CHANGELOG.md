...
| :--- | :--- | :--- |
| **MSI: [x64](https://github.com/BurntToasters/Dacx/releases/download/v0.10.0-beta.7/Dacx-Windows-x64.msi)**<!-- / [arm64](https://github.com/BurntToasters/Dacx/releases/download/v0.10.0-beta.7/Dacx-Windows-arm64.msi)** -->| **[Universal DMG](https://github.com/BurntToasters/Dacx/releases/download/v0.10.0-beta.7/Dacx-macOS.dmg)** | **AppImage:** [x64](https://github.com/BurntToasters/Dacx/releases/download/v0.10.0-beta.7/Dacx-Linux-x86_64.AppImage) |
| <!-- <div align="center"><a href="https://apps.microsoft.com/detail/9pkgd6lkcl5j?referrer=appbadge&mode=full"><img src="https://get.microsoft.com/images/en-us%20light.svg" width="150"/></a></div>--> | **[Universal ZIP](https://github.com/BurntToasters/Dacx/releases/download/v0.10.0-beta.7/Dacx-macOS.zip)** | **DEB:** [x64](https://github.com/BurntToasters/Dacx/releases/download/v0.10.0-beta.7/Dacx-Linux-amd64.deb) <!--/ [arm64](https://github.com/BurntToasters/Dacx/releases/download/v0.10.0-beta.7/Dacx-Linux-arm64.deb)--> |
| <!--*See MSI note below*--> | | **RPM:** [x64](https://github.com/BurntToasters/Dacx/releases/download/v0.10.0-beta.7/Dacx-Linux-x86_64.rpm) <!--/ [arm64](https://github.com/BurntToasters/Dacx/releases/download/v0.10.0-beta.7/Dacx-Linux-aarch64.rpm)--> |
| | | **Flatpak:** [x64](https://github.com/BurntToasters/Dacx/releases/download/v0.10.0-beta.7/Dacx-Linux-x86_64.flatpak) |
| | | **TAR (Generic Linux):** [x64](https://github.com/BurntToasters/Dacx/releases/download/v0.10.0-beta.7/Dacx-Linux-x86_64.tar.gz) <!--/ [arm64](https://github.com/BurntToasters/Dacx/releases/download/v0.10.0-beta.7/Dacx-Linux-aarch64.flatpak)--> |
...
* **NEW - Linux AppImage and Flatpak:** Added AppImage and Flatpak support!
  * **AppImage:** [x64](https://github.com/BurntToasters/Dacx/releases/download/v0.10.0-beta.7/Dacx-Linux-x86_64.AppImage) — portable, no installation needed.
  * **Flatpak:** [x64](https://github.com/BurntToasters/Dacx/releases/download/v0.10.0-beta.7/Dacx-Linux-x86_64.flatpak) — sandboxed package for app-store distributions (Flathub support planned).
